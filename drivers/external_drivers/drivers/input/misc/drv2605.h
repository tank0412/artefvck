...
/* Commands */
#define HAPTIC_CMDID_PLAY_SINGLE_EFFECT		((char)0x01)
#define HAPTIC_CMDID_PLAY_EFFECT_SEQUENCE	((char)0x02)
#define HAPTIC_CMDID_PLAY_TIMED_EFFECT		((char)0x03)
#define HAPTIC_CMDID_GET_DEV_ID			((char)0x04)
#define HAPTIC_CMDID_RUN_DIAG			((char)0x05)
#define HAPTIC_CMDID_AUDIOHAPTIC_ENABLE		((char)0x06)
#define HAPTIC_CMDID_AUDIOHAPTIC_DISABLE	((char)0x07)
#define HAPTIC_CMDID_AUDIOHAPTIC_GETSTATUS	((char)0x08)
#define HAPTIC_CMDID_STOP			((char)0xFF)
