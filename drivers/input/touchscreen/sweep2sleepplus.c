/*
 * Sweep2Wake driver for Zenfone
 * Touchboost support included here
 * 
 * Author: andip71 & TheSSJ , Artefvck, 10.12.2014
 * 
 * Version 1.0.1
 *
...
#define SYNAPTICS_NAME	"synaptics_dsx"

/*****************************************/
/* Module/driver data */
/*****************************************/

#define DRIVER_AUTHOR "andip71 (Lord Boeffla), TheSSJ , Artefvck"
