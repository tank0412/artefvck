...
enum {
	...
	INTEL_MRFL_PHONE_RBY_PRO = 0x0003,
	INTEL_MRFL_PHONE_RBY_ENG = 0x8003,
	INTEL_MRFL_PHONE_MVN_PRO = 0x0004,
	INTEL_MRFL_PHONE_MVN_ENG = 0x8004,
	INTEL_MRFL_PHONE_GLC_PRO = 0x0005,
	INTEL_MRFL_PHONE_GLC_ENG = 0x8005,
...
enum {
	INTEL_MOFD_TABLET_BB_PRO = 0x0000,
	INTEL_MOFD_TABLET_BB_ENG = 0x8000,
	INTEL_MOFD_TABLET_EP_PRO = 0x0001,
	INTEL_MOFD_TABLET_EP_ENG = 0x8001,
...
/* Hardware_ID table for Product_Line_ID == INTEL_MRFL_PHONE_RBY */
enum {
	MRFL_PHONE_RBY_0 = 0x0000,
	MRFL_PHONE_RBY_1 = 0x0001,
	MRFL_PHONE_RBY_UNKNOWN = 0xFFFF
};

/* Hardware_ID table for Product_Line_ID == INTEL_MRFL_PHONE_MVN */
enum {
	MRFL_PHONE_MVN_0 = 0x0000,
	MRFL_PHONE_MVN_1 = 0x0001,
	MRFL_PHONE_MVN_2 = 0x0110,
	MRFL_PHONE_MVN_UNKNOWN = 0xFFFF
};

/* Hardware_ID table for Product_Line_ID == INTEL_MRFL_PHONE_GLC */
enum {
	MRFL_PHONE_GLC_0 = 0x0000,
	MRFL_PHONE_GLC_1 = 0x0001,
	MRFL_PHONE_GLC_UNKNOWN = 0xFFFF
};
