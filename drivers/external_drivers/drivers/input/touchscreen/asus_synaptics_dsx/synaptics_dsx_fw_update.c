...
#define FW_IMAGE_NAME_A500_LCE "synaptics/startup_fw_update_A500_LCE_1593779_354C0103.img"
#define FW_IMAGE_NAME_A500_JTouch "synaptics/startup_fw_update_A500_JTouch_1593779_354A0112.img"
	...
	if (fwu->ext_data_source) {
		...
		if (Read_TP_ID() == 0)	//A500 LCE:ID(11,1) = (GP_CORE_073, GP_CAMERA_S86) = (0,0)
		{
			dev_info(rmi4_data->pdev->dev.parent,
					"%s: TP A500 LCE\n",
					__func__);
			strncpy(fwu->image_name, FW_IMAGE_NAME_A500_LCE, MAX_IMAGE_NAME_LEN);
		}
		else if (Read_TP_ID() == 1)	//A500 JTouch:ID(11,1) = (GP_CORE_073, GP_CAMERA_S86) = (0,1)
		{
			dev_info(rmi4_data->pdev->dev.parent,
					"%s: TP A500 JTouch\n",
					__func__);
			strncpy(fwu->image_name, FW_IMAGE_NAME_A500_JTouch, MAX_IMAGE_NAME_LEN);
		}
